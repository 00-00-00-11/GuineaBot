...
module.exports = {
    ...
    run: async (message, args, client) => {
        ...
        if (!muterole) {
            ...
            muteuser.send(`You are chat muted in **${message.guild.name}** for **${reason}**`).catch(() => message.channel.send("I wasn't able to send a DM to the chat muted user. Don't worry! He was chat muted anyway."))
        }
        ...
        console.log(`${muteuser.user.tag} chat muted in ${message.guild.name} (${message.guild.id}) for ${reason}.`)
    }
}