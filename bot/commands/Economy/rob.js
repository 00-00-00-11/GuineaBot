        ...
        await mongo().then(async (mongoose) => {
            try {
                ...
                if (data1.robCooldown > Date.now()) {
                    ...
                    return message.reply(`You must wait **${hours} hours, ${minutes} minutes, ${seconds} seconds** before robbing again!`)
                } else {
                    ...
                    if (currentWallet2 < 1000) return message.reply("It aint worth it bro, they have less than 1000 coins in their wallet.")
