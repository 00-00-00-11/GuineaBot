...
module.exports = (client) => {
    client.on("guildMemberAdd", async member => {
        let channel = member.guild.channels.cache.find(channel => channel.name.includes("g-welcome"))
        if (!channel) return
        ...
        const attachment = new Discord.MessageAttachment(welcomeCard.toBuffer(), "welcome.png")
