...
module.exports= {
    name: 'setnick',
    category: 'moderation',
    description: 'set user nickname (or self!)',
        ...
        if (member) {
            ...
            const logEmbed = new Discord.MessageEmbed()
                ...
                .addFields(
                    ...
                    { name: 'Moderated on: ', value: `${member.user.tag} (${member.id})`},
                    { name: 'Old nickname: ', value: `${oldnickmention}`, inline: true},
                    { name: 'New nickname: ', value: `${memberArg}`, inline: true},
            ...
            const logEmbed2 = new Discord.MessageEmbed()
                ...
                .setAuthor('Modlog')
                .addFields(
                    { name: 'Old nickname: ', value: `${oldnickself}`, inline: true},
                    { name: 'New nickname: ', value: `${selfArg}`, inline: true},
                    { name: 'Date: ', value: `${message.createdAt.toLocaleString()}`}
                )
                .setThumbnail(message.client.user.avatarURL())
                .setTimestamp()
